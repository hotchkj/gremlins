...
=== ":material-debian: deb"
    ...
    the [release page](https://github.com/hotchkj/gremlins/releases/latest), then install with:
...
```sh
go install github.com/hotchkj/gremlins/cmd/gremlins@v{{ release.full_version }}
```
...
the [release page](https://github.com/hotchkj/gremlins/releases/latest), then:
